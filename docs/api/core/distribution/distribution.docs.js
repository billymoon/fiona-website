...
const Section = ({ seed }) => (
  ...
  >
    <p>
      ...
      <code>Fiona.Choice</code>{" "}
      and any other methods that rely on them. The primary use case for this
      method is to create more realistic data.
    </p>

    <p>
      The distribution method sets the distribution function on a seeded
      instance so that future calls to <code>seeded.random</code>{" "}
