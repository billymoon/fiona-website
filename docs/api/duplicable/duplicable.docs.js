...
const Section = ({ seed }) => (
  ...
  >
    ...
    <p>
      In this example, the pool is 2, and the frequency is <b>0.6</b>{" "}
      so the numbers will be <b>373260</b> or{" "}
      <b>153925</b>, 60% of the time, and the other numbers will be pseudo
      random according to the input seed.
    </p>
